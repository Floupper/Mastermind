...
public class Classique extends JFrame {
    ...
    public Classique(String nomJoueur, int spnNbMancheValue, int spnPionsCombinaisonValue, int spnNbTentativesValue,
    ...
    public void addIndice() {
        ...
        for(int i = 0; i < partie.get_manches().get_ligneIndice().getNbPositionCouleur(); i++)
        {
        ...
        for(int i = 0; i < partie.get_manches().get_ligneIndice().getAbsent(); i++)
        {
